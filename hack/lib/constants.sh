...
readonly OS_GO_PACKAGE=github.com/openshift/monitor-imagestream-import
...
readonly OS_ALL_IMAGES=(
  openshift/openshift-monitor-imagestream-import
)

# os::build::images builds all images in this repo.
function os::build::images() {
  tag_prefix="${OS_IMAGE_PREFIX:-"openshift/openshift"}"
  os::build::image "${tag_prefix}-monitor-imagestream-import" images/openshift-monitor-imagestream-import
}
